...
# scipy.io.savemat("1000nam_default_IASoff_raw_cov.mat",{"covar":cov_raw.data})

################
### uncomment to use matlab matrix to create new raw with our processed data
# datarec_fos = mat73.loadmat('1000nam_default_IASoff_fos.mat')
# data = datarec_fos["data_rec_fos"]
# ##sss
# # datarec_vsh = mat73.loadmat('1000nam_default_IASoff_sss.mat')
